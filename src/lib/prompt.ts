...
export function buildSystemPrompt({
  ...
  const versionRule: Record<LangCode, string> = {
    ...
    en: "English NIV.",
    ja: "Japanese 新共同訳 (Shinkyōdōyaku).",
    zh: "Chinese Union Version, Simplified (和合本).",
    "zh-TW": "Chinese Union Version, Traditional (和合本).",
    es: "Spanish Reina-Valera.",
    pt: "Portuguese Almeida.",
    fr: "French Louis Segond.",
    de: "German Lutherbibel.",
    it: "Italian Nuova Riveduta.",
    nl: "Dutch NBV (Nieuwe Bijbelvertaling).",
    ru: "Russian Synodal Version (Синодальный перевод).",
    uk: "Ukrainian Ohiyenko translation (Переклад Огієнка).",
    pl: "Polish Biblia Tysiąclecia.",
    cs: "Czech Ecumenical Version (Český ekumenický překlad).",
    hu: "Hungarian új fordítású (Magyar Bibliatársulat).",
    ro: "Romanian Cornilescu.",
    tr: "Turkish Kutsal Kitap.",
    th: "Thai Standard Version.",
    vi: "Vietnamese Bản Truyền Thống (1926).",
    id: "Indonesian Terjemahan Baru (TB).",
    ms: "Malay Alkitab Berita Baik.",
    tl: "Filipino Magandang Balita Biblia.",
    hi: "Hindi OV (OV Hindi).",
    bn: "Bengali Common Language Bible.",
    ta: "Tamil Old Version (Tamil O.V.).",
    te: "Telugu Old Version (Telugu O.V.).",
    ar: "Arabic Smith & Van Dyke (فاندايك).",
    fa: "Persian Today's Persian Version / Hezareh-ye No (ترجمهٔ هزارهٔ نو).",
    sw: "Swahili Biblia Habari Njema (Swahili Union).",
  };
